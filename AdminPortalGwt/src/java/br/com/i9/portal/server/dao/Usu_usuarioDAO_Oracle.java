...
public class Usu_usuarioDAO_Oracle extends ObjectDAO implements IUsu_usuarioDAO {
    ...
    public void insert(Usu_usuarioTGWT usu_usuarioT) throws Exception {
        ...
        try {
            String sql = "insert into usr_portal.usu_usuario  ( usu_tx_nome, usu_tx_login, usu_tx_senha, usu_tx_status, usu_tx_email, usu_tx_trocarsenha) values ( ? , ? , ? , ? , ?, ? )";
    ...
    public List<Usu_usuarioTGWT> getByUsu_tx_nome(Usu_usuarioTGWT usu_usuarioT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.usu_usuario where  Upper(usu_tx_nome) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, '%' + usu_usuarioT.getUsu_tx_nome() + '%');
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<Usu_usuarioTGWT> getByUsu_tx_login(Usu_usuarioTGWT usu_usuarioT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.usu_usuario where  Upper(usu_tx_login) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<Usu_usuarioTGWT> getByUsu_tx_email(Usu_usuarioTGWT usu_usuarioT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.usu_usuario where  Upper(usu_tx_email) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public void updateSenha(Usu_usuarioTGWT usu_usuarioT) throws Exception {
        PreparedStatement pStmt = null;
        try {
            String sql = "update usr_portal.usu_usuario set usu_tx_trocarsenha='S', usu_tx_senha=?  where  usu_nr_id=?";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, usu_usuarioT.getUsu_tx_senha());
    ...
    public List<Usu_usuarioTGWT> getByPerfil(Per_perfilTGWT perT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.usu_usuario usu where usu.usu_nr_id in (select distinct usu_nr_id from usr_portal.pu_per_usu where per_nr_id=?)  order by usu_tx_nome ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<Usu_usuarioTGWT> getByNotPerfil(Per_perfilTGWT perT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.usu_usuario usu where usu.usu_nr_id not in (select distinct usu_nr_id from usr_portal.pu_per_usu where per_nr_id=?)  order by usu_tx_nome ";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, perT.getPer_nr_id());
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<Usu_usuarioTGWT> getByNomeLogin(String texto) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.usu_usuario usu where upper(usu_tx_nome) like upper(?) or upper(usu_tx_login) like upper(?) order by usu_tx_nome ";
            pStmt = con.prepareStatement(sql);
