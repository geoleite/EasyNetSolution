...
public class LogDAO_Oracle extends ObjectDAO implements ILogDAO {

    public LogDAO_Oracle(DAOFactory dao) throws Exception {
        setDAOFactory(dao);
        con = dao.create();
    }
    ...
    public void insert(LogTGWT logT) throws Exception {
        ...
        try {
            String sql = "insert into usr_portal.log  ( log_nr_id, log_tx_sistema, log_tx_classe, log_tx_metodo, log_tx_usuario, log_dt_datahora, log_tx_status, log_tx_ip, log_tx_parametros) values ( ? , ? , ? , ? , ? , ? , ? , ? , ? )";
    ...
    public void update(LogTGWT logT) throws Exception {
        PreparedStatement pStmt = null;
        try {
            String sql = "update usr_portal.log set  log_tx_sistema=?, log_tx_classe=?, log_tx_metodo=?, log_tx_usuario=?, log_dt_datahora=?, log_tx_status=?, log_tx_ip=?, log_tx_parametros=?  where  log_nr_id=?";
            pStmt = con.prepareStatement(sql);
    ...
    public void delete(LogTGWT logT) throws Exception {
        PreparedStatement pStmt = null;
        try {
            String sql = "delete from usr_portal.log where  log_nr_id=?";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, logT.getLog_nr_id());
            pStmt.execute();
        } catch (Exception e) {
    ...
    public List<LogTGWT> getAll() throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.log";
            pStmt = con.prepareStatement(sql);
    ...
    public List<LogTGWT> getByPK(LogTGWT logT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.log where  log_nr_id=?";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, logT.getLog_nr_id());
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<LogTGWT> getByLog_tx_sistema(LogTGWT logT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.log where  Upper(log_tx_sistema) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, '%' + logT.getLog_tx_sistema() + '%');
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<LogTGWT> getByLog_tx_classe(LogTGWT logT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.log where  Upper(log_tx_classe) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<LogTGWT> getByLog_tx_metodo(LogTGWT logT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.log where  Upper(log_tx_metodo) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<LogTGWT> getByLog_tx_usuario(LogTGWT logT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.log where  Upper(log_tx_usuario) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<LogTGWT> getByLog_dt_datahora(LogTGWT logT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.log where  log_dt_datahora = ? ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<LogTGWT> getByLog_tx_status(LogTGWT logT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.log where  Upper(log_tx_status) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<LogTGWT> getByLog_tx_ip(LogTGWT logT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.log where  Upper(log_tx_ip) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<LogTGWT> getByLog_tx_parametros(LogTGWT logT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.log where  Upper(log_tx_parametros) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
