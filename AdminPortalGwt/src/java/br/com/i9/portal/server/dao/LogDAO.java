...
public class LogDAO extends ObjectDAOClusterAdminPortal implements ILogDAO {
    ...
    public void insert(LogTGWT logT) throws Exception {
        ...
        try {
            String sql = "insert into portal.log  ( log_nr_id, log_tx_sistema, log_tx_classe, log_tx_metodo, log_tx_usuario, log_dt_datahora, log_tx_status, log_tx_ip, log_tx_parametros) values ( ? , ? , ? , ? , ? , ? , ? , ? , ? )";
    ...
    public void update(LogTGWT logT) throws Exception {
        PreparedStatement pStmt = null;
        try {
            String sql = "update portal.log set  log_tx_sistema=?, log_tx_classe=?, log_tx_metodo=?, log_tx_usuario=?, log_dt_datahora=?, log_tx_status=?, log_tx_ip=?, log_tx_parametros=?  where  log_nr_id=?";
            pStmt = createPrepareStatment(sql);
    ...
    public List<LogTGWT> getByLog_tx_status(LogTGWT logT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from portal.log where  Upper(log_tx_status) like Upper(?) ";
            pStmt = createPrepareStatment(sql);
    ...
    public List<LogTGWT> getByLog_tx_ip(LogTGWT logT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from portal.log where  Upper(log_tx_ip) like Upper(?) ";
            pStmt = createPrepareStatment(sql);
    ...
    public List<LogTGWT> getByLog_tx_parametros(LogTGWT logT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from portal.log where  Upper(log_tx_parametros) like Upper(?) ";
            pStmt = createPrepareStatment(sql);
