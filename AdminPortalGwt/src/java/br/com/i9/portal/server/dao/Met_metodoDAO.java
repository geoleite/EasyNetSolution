...
public class Met_metodoDAO extends ObjectDAOClusterAdminPortal implements IMet_metodoDAO {
    ...
    public List<Met_metodoTGWT> getAll() throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from portal.met_metodo";
            pStmt = createPrepareStatment(sql);
    ...
    public List<Met_metodoTGWT> getByPK(Met_metodoTGWT met_metodoT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from portal.met_metodo where  met_nr_id=?";
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, met_metodoT.getMet_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<Met_metodoTGWT> getByOperacaoPerfil(Met_metodoTGWT met_metodoT, Per_perfilTGWT perT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from portal.met_metodo met where met.ope_nr_id = ? and met.met_nr_id  in (select distinct met_nr_id from portal.opm_met_ope_per where per_nr_id=?) order by met_tx_metodo ";
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, met_metodoT.getOpe_nr_id());
    ...
    public List<Met_metodoTGWT> getByOperacaoNaoPerfil(Met_metodoTGWT met_metodoT, Per_perfilTGWT perT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from portal.met_metodo met where met.ope_nr_id = ? and met.met_nr_id not in (select distinct met_nr_id from portal.opm_met_ope_per where per_nr_id=?) order by met_tx_metodo ";
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, met_metodoT.getOpe_nr_id());
            pStmt.setObject(2, perT.getPer_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<Met_metodoTGWT> getByMet_tx_metodo(Met_metodoTGWT met_metodoT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from portal.met_metodo where  Upper(met_tx_metodo) like Upper(?) ";
            pStmt = createPrepareStatment(sql);
    ...
    public List<Met_metodoTGWT> getByMet_tx_status(Met_metodoTGWT met_metodoT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from portal.met_metodo where  Upper(met_tx_status) like Upper(?) ";
            pStmt = createPrepareStatment(sql);
    ...
    public List<Met_metodoTGWT> getBySis_nr_id(Met_metodoTGWT met_metodoT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from portal.met_metodo where  sis_nr_id = ? ";
            pStmt = createPrepareStatment(sql);
    ...
    public List<Met_metodoTGWT> getByMet_tx_descricao(Met_metodoTGWT met_metodoT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from portal.met_metodo where  Upper(met_tx_descricao) like Upper(?) ";
            pStmt = createPrepareStatment(sql);
    ...
    public List<Met_metodoTGWT> getByOpe_operacao(Met_metodoTGWT met_metodoT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from portal.met_metodo where ope_operacao.ope_nr_id=? and ope_operacao.sis_nr_id=?  ";
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, met_metodoT.getOpe_nr_id());
