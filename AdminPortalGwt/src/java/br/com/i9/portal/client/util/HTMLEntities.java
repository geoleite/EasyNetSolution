package br.com.i9.portal.client.util;
...
public class HTMLEntities {
     ...
     */
    private static final TreeMap htmlentities_map = new TreeMap();
    /**
     * Map to convert html entities in exteden characters.
     */
    private static final TreeMap unhtmlentities_map = new TreeMap();
    ...
    public static String encode(String str) {
        if (str != null) {
            str = HTMLEntities.htmlAmpersand(str);
            str = HTMLEntities.htmlDoubleQuotes(str);
            str = HTMLEntities.htmlQuotes(str);
            str = HTMLEntities.htmlSingleQuotes(str);
            str = HTMLEntities.htmlentities(str);
            str = HTMLEntities.htmlAngleBrackets(str);
            str= str.replace("\\", "@_");
            str= str.replace("&", "@$");
            str= str.replace("#", "@*");
        }
