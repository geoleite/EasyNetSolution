 ...
 * @author geoleite
 */
public class CPAlterarExcluirBaseControleInterfaceGWT extends CPBaseControleInterfaceGWT  implements Listener<ButtonEvent> {
    ...
    public CPAlterarExcluirBaseControleInterfaceGWT() {
