 ...
 * @author marcos
 */
public class AlterarExcluirBaseControleInterfaceGWT extends BaseControleInterfaceGWT implements Listener<ButtonEvent> {
    ...
    public AlterarExcluirBaseControleInterfaceGWT() {
