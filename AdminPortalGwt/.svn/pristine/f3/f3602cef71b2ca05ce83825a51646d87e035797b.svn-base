...
public class Men_menuDAO_Mysql extends ObjectDAO implements IMen_menuDAO {

    public Men_menuDAO_Mysql(DAOFactory dao) throws Exception {
        setDAOFactory(dao);
        con = dao.create();
    }
    ...
    public void insert(Men_menuTGWT men_menuT) throws Exception {
        ...
        try {
            String sql = "insert into men_menu  ( supermenu_nr_id, men_tx_status, men_tx_nome, men_nr_ordem, men_tx_url, men_tx_acao, sis_nr_id, men_tx_icone, men_tx_tipo) values (?, ? , ? , ? , ? , ? , ? , ? , ? )";
    ...
    public void update(Men_menuTGWT men_menuT) throws Exception {
        PreparedStatement pStmt = null;
        try {
            String sql = "update men_menu set  supermenu_nr_id=?, men_tx_status=?, men_tx_nome=?, men_nr_ordem=?, men_tx_url=?, men_tx_acao=?, sis_nr_id=?, men_tx_icone=?, men_tx_tipo=?  where  men_nr_id=?";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, men_menuT.getSupermenu_nr_id());
            pStmt.setObject(2, men_menuT.getMen_tx_status());
            pStmt.setObject(3, men_menuT.getMen_tx_nome());
    ...
    public List<Men_menuTGWT> getAll() throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from men_menu order by men_nr_ordem, men_tx_nome";
            pStmt = con.prepareStatement(sql);
    ...
    public List<Men_menuTGWT> getByPerfil(Per_perfilTGWT perT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from men_menu men where men.men_nr_id  in (select distinct men_nr_id from mep_men_per where per_nr_id=?)  order by men_nr_ordem, men_tx_nome";
            pStmt = con.prepareStatement(sql);
    ...
    public List<Men_menuTGWT> getByNotPerfil(Per_perfilTGWT perT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from men_menu men where men.men_nr_id not in (select distinct men_nr_id from mep_men_per where per_nr_id=?)  order by men_nr_ordem, men_tx_nome";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, perT.getPer_nr_id());
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<Men_menuTGWT> getBySupermenu_nr_id(Men_menuTGWT men_menuT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from men_menu where  supermenu_nr_id = ? order by men_nr_ordem, men_tx_nome";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, men_menuT.getSupermenu_nr_id());
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<Men_menuTGWT> getByMen_nr_ordem(Men_menuTGWT men_menuT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from men_menu where  men_nr_ordem = ? order by men_nr_ordem";
            pStmt = con.prepareStatement(sql);
    ...
    public List<Men_menuTGWT> getByMen_tx_url(Men_menuTGWT men_menuT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from men_menu where  Upper(men_tx_url) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<Men_menuTGWT> getByMen_tx_acao(Men_menuTGWT men_menuT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from men_menu where  Upper(men_tx_acao) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<Men_menuTGWT> getBySis_nr_id(Men_menuTGWT men_menuT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from men_menu where  sis_nr_id = ? order by men_nr_ordem, men_tx_nome";
            pStmt = con.prepareStatement(sql);
    ...
    public List<Men_menuTGWT> getByMen_tx_icone(Men_menuTGWT men_menuT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from men_menu where  Upper(men_tx_icone) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
