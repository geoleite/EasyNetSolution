...
public class Ope_operacaoConsultGWT1 extends BaseBorderLayoutGWT {
    ...
    private void loadOperacoes() {
        ...
        Ope_operacaoServiceAsync serviceAsync = GWT.create(Ope_operacaoService.class);
...
//        timer.schedule(500);
    ...
    private void loadSistemas() {
        ...
        Sis_sistemaServiceAsync async = GWT.create(Sis_sistemaService.class);
...
//        timer.schedule(500);
    ...
    public void montarTela(Ope_operacaoTGWT opt) {
        ...
        Met_metodoServiceAsync serviceAsync = GWT.create(Met_metodoService.class);
        ...
        Met_metodoServiceAsync serviceAsyncNOT = GWT.create(Met_metodoService.class);
...
//        timer.schedule(500);
    ...
    public void adicionarMetodo(Met_metodoTGWT met_metodoTGWT) {
        ...
        Opm_met_ope_perServiceAsync serviceAsync = GWT.create(Opm_met_ope_perService.class);
