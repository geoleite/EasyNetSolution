 ...
 * @author George Leite
 */
public class InsUpDelBaseGWT extends BaseGWT implements Listener<ButtonEvent> {
    ...
    public void handleEvent(ButtonEvent be) {
        ...
        getBtnInsert().addListener(Events.OnClick, this);
        btnClear.addListener(Events.OnClick, this);
        btnClose.addListener(Events.OnClick, this);

        getBtnInsert().setIcon(ICONS.aplicar());
        btnClose.setIcon(ICONS.sair());
        btnClear.setIcon(ICONS.limpar());
    }
