...
<jsp:useBean id="res_recall_senhaJB" class="br.com.i9.portal.jb.Res_recall_senhaUpdateDeleteJB" scope="request"/>                                         
...
{"msg":"${res_recall_senhaJB.msg}",
 ...
 ,	"res_tx_resposta":"${res_recall_senhaJB.res_recall_senhaT.res_tx_resposta}"
