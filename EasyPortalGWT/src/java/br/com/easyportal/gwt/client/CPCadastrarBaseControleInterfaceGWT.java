 ...
 * @author geoleite
 */
public class CPCadastrarBaseControleInterfaceGWT extends CPBaseControleInterfaceGWT implements Listener<ButtonEvent> {
    private ToolBar toolBarMaster = new ToolBar();
    private Button btnInsert = new Button(" Inserir ");
    private Button btnLimpar = new Button(" Limpar ");
    private Button btnFechar = new Button(" Fechar ");

    public CPCadastrarBaseControleInterfaceGWT(){
