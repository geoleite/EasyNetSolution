...
public class Ope_operacaoUpdateDeleteGWT extends AlterarExcluirBaseGWT {
    ...
    public Ope_operacaoUpdateDeleteGWT() {
        ...
        getCpMaster().add(new LabelField("Classe Java:"));
    ...
    public void load(Ope_operacaoTGWT ope_operacaoT) {
        ...
        //ope_tx_status.setValue(ope_operacaoT.getOpe_tx_status()=="A");
        if ("A".equalsIgnoreCase(ope_operacaoT.getOpe_tx_status())) {
            rOpe_tx_statusAtivo.setValue(true);
        } else {
            rOpe_tx_statusInativo.setValue(true);
        }
    }
