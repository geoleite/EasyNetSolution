...
public class Res_recall_senhaDAOGWT implements IListenetResponse {
    ...
    public static final String PAGE_INSERT = "portalgwt/res_recall_senhaInsertGWT.jsp";
    ...
    public static final String PAGE_UPDATE_DELETE = "portalgwt/res_recall_senhaUpdateDeleteGWT.jsp";
    ...
    public void findByPK(Res_recall_senhaTGWT res_recall_senhaT) {
        IListenetResponse listener = new IListenetResponse() {
    ...
    public void findByLoginEmail(String login, String email) {
        IListenetResponse listener = new IListenetResponse() {
    ...
    public void generatePassword(Res_recall_senhaTGWT resT) {
        IListenetResponse listener = new IListenetResponse() {
        ...
        String url = Constantes.URL + PAGE_UPDATE_DELETE;
        HashMap<String, String> param = new HashMap<String, String>();
        param.put("op", "generatePassword");
        param.put("res_recall_senhaT.usu_nr_id", resT.getUsu_nr_id() + "");
        param.put("res_recall_senhaT.res_tx_resposta", resT.getRes_tx_resposta());
