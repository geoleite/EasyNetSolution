...
public class Usu_por_canDAO_Oracle extends ObjectDAO implements IUsu_por_canDAO {

    private ResultSet rs = null;
    private PreparedStatement pStmt = null;

    public Usu_por_canDAO_Oracle(DAOFactory dao) throws Exception {
        setDAOFactory(dao);
        con = dao.create();
    }
    ...
    public void insert(Usu_por_canT usu_por_canT) throws Exception {
        try {
            String sql = "insert into usr_portal.usu_por_can  ( usu_nr_id, por_nr_id, can_nr_id, upc_tx_status, upc_nr_ordem) values ( ? , ? , ? , ? , ? )";
    ...
    public void update(Usu_por_canT usu_por_canT) throws Exception {
        try {
            String sql = "update usr_portal.usu_por_can set  upc_tx_status=?, upc_nr_ordem=?  where  usu_nr_id=? and por_nr_id=? and can_nr_id=?";
            pStmt = con.prepareStatement(sql);
    ...
    public void delete(Usu_por_canT usu_por_canT) throws Exception {
        try {
            String sql = "delete from usr_portal.usu_por_can where  usu_nr_id=? and por_nr_id=? and can_nr_id=?";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, usu_por_canT.getUsu_nr_id());
            pStmt.setObject(2, usu_por_canT.getPor_nr_id());
            pStmt.setObject(3, usu_por_canT.getCan_nr_id());
    ...
    public List<Usu_por_canT> getAll() throws Exception {
        try {
            String sql = "select * from usr_portal.usu_por_can";
            pStmt = con.prepareStatement(sql);
    ...
    public List<Usu_por_canT> getById(Usu_por_canT usu_por_canT) throws Exception {
        try {
            String sql = "select * from usr_portal.usu_por_can where  usu_nr_id=? and por_nr_id=? and can_nr_id=?";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, usu_por_canT.getUsu_nr_id());
            pStmt.setObject(2, usu_por_canT.getPor_nr_id());
            pStmt.setObject(3, usu_por_canT.getCan_nr_id());
    ...
    public List<Usu_por_canT> getByUpc_tx_status(Usu_por_canT usu_por_canT) throws Exception {
        try {
            String sql = "select * from usr_portal.usu_por_can where  Upper(upc_tx_status) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, '%' + usu_por_canT.getUpc_tx_status() + '%');
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<Usu_por_canT> getByUpc_nr_ordem(Usu_por_canT usu_por_canT) throws Exception {
        try {
            String sql = "select * from usr_portal.usu_por_can where  upc_nr_ordem = ? ";
            pStmt = con.prepareStatement(sql);
