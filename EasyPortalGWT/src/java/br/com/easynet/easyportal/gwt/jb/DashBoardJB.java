 ...
 * @author geoleite
 */
public class DashBoardJB extends EasySecurityJB implements INotSecurity, INotLog  {
    private Usu_usuarioT usu_usuarioT;
    private static final String MENU_MONTADO = "dash_usuario_logado_GWT";
     ...
     * @throws Exception
     */
    private void loadDashPerfil() throws Exception {
        List<Men_menuT> list = null;
            list = menuDao.getAllUsuarioDash(usu_usuarioT);
        ...
        try {
            ...
            if (usu_usuarioT != null) {
                if (getSession().getAttribute(MENU_MONTADO) != null) {
                    setMenu((ItemMenu) getSession().getAttribute(MENU_MONTADO));
                } else {
...
//                    String sql = "select men.men_nr_id, men.supermenu_nr_id, men.men_tx_nome, men.men_tx_acao, sis.sis_tx_nome from portal.pu_per_usu pu, portal.mep_men_per mep, portal.men_menu men, portal.sis_sistema sis where pu.usu_nr_id=? and pu.per_nr_id=mep.per_nr_id and  mep.men_nr_id=men.men_nr_id and men.men_tx_status='A' and  men.supermenu_nr_id=0 and men.sis_nr_id=sis.sis_nr_id order by men.men_nr_ordem";
                    ...
                    menuPrimario = menuDao.getMenuPrimarioDash(usu_usuarioT);
                    ...
                    getSession().setAttribute(MENU_MONTADO, getMenu());
                }
