...
public class Usu_usuarioDAO_Oracle extends ObjectDAO implements IUsu_usuarioDAO {

    private static Object sinal = "sinal";
    private ResultSet rs = null;
    private PreparedStatement pStmt = null;

    public Usu_usuarioDAO_Oracle(DAOFactory dao) throws Exception {
        setDAOFactory(dao);
        con = dao.create();
    }
    ...
    public void insert(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "insert into usr_portal.usu_usuario  ( usu_tx_nome, usu_tx_login, usu_tx_senha, usu_tx_status, usu_tx_email, usu_tx_trocarsenha, usu_dt_cadastro) values ( ? , ? , ? , ?, ?, ?,? )";
    ...
    public int getCodigoAutoIncremento() throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select max(usu_nr_id) from usr_portal.usu_usuario";
            pStmt = con.prepareStatement(sql);
    ...
    public void update(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "update usr_portal.usu_usuario set  usu_tx_nome=?, usu_tx_login=?, usu_tx_senha=?, usu_tx_status=?, usu_tx_email=?, usu_tx_trocarsenha=?  where  usu_nr_id=?";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, usu_usuarioT.getUsu_tx_nome());
            pStmt.setObject(2, usu_usuarioT.getUsu_tx_login());
            pStmt.setObject(3, usu_usuarioT.getUsu_tx_senha());
    ...
    public void updateSenha(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "update usr_portal.usu_usuario set  usu_tx_senha=?, usu_tx_trocarsenha='N' where  usu_nr_id=?";
            pStmt = con.prepareStatement(sql);
    ...
    public void updateTrocarSenha(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "update usr_portal.usu_usuario set  usu_tx_trocarsenha=? where  usu_nr_id=?";
            pStmt = con.prepareStatement(sql);
    ...
    public void updateDados(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "update usr_portal.usu_usuario set  usu_tx_nome=?, usu_tx_login=?, usu_tx_status=?, usu_tx_email=?, usu_tx_trocarsenha=?   where  usu_nr_id=?";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, usu_usuarioT.getUsu_tx_nome());
            pStmt.setObject(2, usu_usuarioT.getUsu_tx_login());
    ...
    public void delete(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "delete from usr_portal.usu_usuario where  usu_nr_id=?";
            pStmt = con.prepareStatement(sql);
    ...
    public List<Usu_usuarioT> getAll() throws Exception {
        try {
            String sql = "select * from usr_portal.usu_usuario";
            pStmt = con.prepareStatement(sql);
            rs = pStmt.executeQuery();
    ...
    public Usu_usuarioT getUltimoUsuarioInserido() throws Exception {
        try {
            String sql = "select * from usr_portal.usu_usuario where usu_nr_id =(select max(usu_nr_id) from usr_portal.usu_usuario)";
            pStmt = con.prepareStatement(sql);
            rs = pStmt.executeQuery();
    ...
    public List<Usu_usuarioT> getUsuariosPortal(Por_portalT porT) throws Exception {
        try {
            String sql = "select * from usr_portal.usu_usuario where usu_nr_id in (select usu_nr_id from canais.por_usu where por_nr_id=?) order by usu_tx_nome";
            pStmt = con.prepareStatement(sql);
    ...
    public List<Usu_usuarioT> getUsuariosNaoPortal(Por_portalT porT) throws Exception {
        try {
            String sql = "select * from usr_portal.usu_usuario where usu_nr_id not in (select usu_nr_id from canais.por_usu where por_nr_id=?) order by usu_tx_nome";
            pStmt = con.prepareStatement(sql);
            pStmt.setInt(1, porT.getPor_nr_id());
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<Usu_usuarioT> getUsuariosPerfil(Per_perfilT per_perfilT) throws Exception {
        try {
            String sql = "select * from usr_portal.usu_usuario where usu_nr_id in (select usu_nr_id from usr_portal.pu_per_usu pu where pu.per_nr_id=?) order by usu_tx_nome";
            pStmt = con.prepareStatement(sql);
    ...
    public List<Usu_usuarioT> getUsuariosNaoPerfil(Per_perfilT per_perfilT) throws Exception {
        try {
            String sql = "select * from usr_portal.usu_usuario where usu_nr_id not in (select usu_nr_id from usr_portal.pu_per_usu pu where pu.per_nr_id=?) order by usu_tx_nome";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, per_perfilT.getPer_nr_id());
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<Usu_usuarioT> getById(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "select * from usr_portal.usu_usuario where  usu_nr_id=?";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, usu_usuarioT.getUsu_nr_id());
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<Usu_usuarioT> getByUsu_tx_nome(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "select * from usr_portal.usu_usuario where  Upper(usu_tx_nome) like Upper(?) order by usu_tx_nome";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, '%' + usu_usuarioT.getUsu_tx_nome() + '%');
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<Usu_usuarioT> getByNomeLogin(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "select * from usr_portal.usu_usuario where  (Upper(usu_tx_nome) like Upper(?)) or (Upper(usu_tx_login) like Upper(?))order by usu_tx_nome";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, '%' + usu_usuarioT.getUsu_tx_nome() + '%');
            pStmt.setObject(2, '%' + usu_usuarioT.getUsu_tx_login() + '%');
            rs = pStmt.executeQuery();
    ...
    public List<Usu_usuarioT> getByLoginEmail(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "select * from usr_portal.usu_usuario where  Upper(usu_tx_login) like Upper(?)  and usu_tx_email==? order by usu_tx_nome";
            pStmt = con.prepareStatement(sql);
    ...
    public List<Usu_usuarioT> getByUsu_tx_login(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "select * from usr_portal.usu_usuario where  Upper(usu_tx_login) like Upper(?)  order by usu_tx_nome";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, usu_usuarioT.getUsu_tx_login());
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<Usu_usuarioT> getByAutentication(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "select * from usr_portal.usu_usuario where  usu_tx_login = ? and usu_tx_senha= ? and usu_tx_status='A'";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, usu_usuarioT.getUsu_tx_login());
    ...
    public List<Usu_usuarioT> getByUsu_tx_senha(Usu_usuarioT usu_usuarioT) throws Exception {
        String sql = "select * from usr_portal.usu_usuario where  Upper(usu_tx_senha) like Upper(?) ";
    ...
    public List<Usu_usuarioT> getByUsu_tx_status(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "select * from usr_portal.usu_usuario where  Upper(usu_tx_status) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
