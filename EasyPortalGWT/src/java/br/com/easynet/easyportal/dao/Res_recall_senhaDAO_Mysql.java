...
public class Res_recall_senhaDAO_Mysql extends ObjectDAOClusterEasyPortal implements IRes_recall_senhaDAO{

    public Res_recall_senhaDAO_Mysql(DAOFactoryCluster dao) throws Exception {
    ...
    public List<Res_recall_senhaT> getByLoginEmail(String login, String email) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select res.* from portal.res_recall_senha res, portal.usu_usuario usu where  usu.usu_tx_login=? and usu.usu_tx_email=? and usu.nr_id=res.usu_nr_id";
            pStmt = createPrepareStatment(sql);
