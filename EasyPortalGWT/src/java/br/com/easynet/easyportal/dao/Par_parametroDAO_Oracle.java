...
public class Par_parametroDAO_Oracle extends ObjectDAOClusterEasyPortal implements IPar_parametroDAO{

    public Par_parametroDAO_Oracle(DAOFactoryCluster dao) throws Exception {
        //setDAOFactory(dao);
        //con = dao.create();
    ...
    public void insert(Par_parametroT par_parametroT) throws Exception {
        ...
        try {
            String sql = "insert into usr_portal.par_parametro  ( sis_nr_id, par_tx_nome, par_tx_valor) values ( ? , ? , ? )";
    ...
    public void update(Par_parametroT par_parametroT) throws Exception {
        PreparedStatement pStmt = null;
        try {
            String sql = "update usr_portal.par_parametro set  par_tx_valor=?, sis_nr_id=?, par_tx_nome=?  where par_nr_id=? ";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public void delete(Par_parametroT par_parametroT) throws Exception {
        PreparedStatement pStmt = null;
        try {
            String sql = "delete from usr_portal.par_parametro where  sis_nr_id=? and par_tx_nome=?";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, par_parametroT.getSis_nr_id());
            pStmt.setObject(2, par_parametroT.getPar_tx_nome());
    ...
    public List<Par_parametroT> getAll() throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.par_parametro order by sis_nr_id, par_tx_nome";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public Par_parametroT getByPK(Par_parametroT par_parametroT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.par_parametro where  sis_nr_id=? and par_tx_nome=? ";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, par_parametroT.getSis_nr_id());
            pStmt.setObject(2, par_parametroT.getPar_tx_nome());
    ...
    public List<Par_parametroT> getByPar_tx_nome(Par_parametroT par_parametroT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.par_parametro where  Upper(par_tx_nome) like Upper(?) order by par_tx_nome";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Par_parametroT> getByPar_tx_valor(Par_parametroT par_parametroT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from usr_portal.par_parametro where  Upper(par_tx_valor) like Upper(?)  order by par_tx_nome";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, '%' + par_parametroT.getPar_tx_valor() + '%');
            rs = pStmt.executeQuery();
