...
public class Con_componente_negadoDAO extends ObjectDAOClusterEasyPortal implements ICon_componente_negadoDAO {

    public Con_componente_negadoDAO(DAOFactoryCluster dao) throws Exception {
        //setDAOFactory(dao);
        //con = dao.create();
