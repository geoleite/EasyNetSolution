...
import br.com.easynet.easyportal.sql.SqlEasyPortal;
...
public class Men_menuDAO extends ObjectDAOClusterEasyPortal implements IMen_menuDAO {

    private ResultSet rs = null;
    private PreparedStatement pStmt = null;
    private SqlEasyPortal sqlEasyPortal = new SqlEasyPortal();
    ...
    public void insert(Men_menuT men_menuT) throws Exception {
        try {
            //String sql = "insert into portal.men_menu  ( supermenu_nr_id, men_tx_status, men_tx_nome, men_nr_ordem, men_tx_url, sis_nr_id, men_tx_acao, men_tx_icone) values ( ? , ? , ? , ? , ?, ?, ?, ? )";
            //PreparedStatement pStmt = con.prepareStatement(sql);
            String sql = sqlEasyPortal.getSql("insert_menu");
    ...
    public void update(Men_menuT men_menuT) throws Exception {
        try {
            //String sql = "update portal.men_menu set  supermenu_nr_id=?, men_tx_status=?, men_tx_nome=?, men_nr_ordem=?, men_tx_url=?, sis_nr_id=?, men_tx_acao=?, men_tx_icone=?  where  men_nr_id=?";
            //pStmt = con.prepareStatement(sql);
            String sql = sqlEasyPortal.getSql("update_menu");
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, men_menuT.getSupermenu_nr_id());
            pStmt.setObject(2, men_menuT.getMen_tx_status());
            pStmt.setObject(3, men_menuT.getMen_tx_nome());
    ...
    public void delete(Men_menuT men_menuT) throws Exception {
        try {
            ...
            String sql = sqlEasyPortal.getSql("delete_menu");
            //pStmt = con.prepareStatement(sql);
    ...
    public List<Men_menuT> getSubMenu(Men_menuT menT) throws Exception {
        try {
            //String sql = "select * from portal.men_menu men where men.supermenu_nr_id=? order by men_nr_ordem, men_tx_nome";
            String sql = sqlEasyPortal.getSql("sub_menu");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getMenuPrimario(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            ...
            String sql = sqlEasyPortal.getSql("menu_primario");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getMenuPrimarioDash(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            //String sql = "select men.* from portal.pu_per_usu pu, portal.mep_men_per mep, portal.men_menu men where pu.usu_nr_id=? and pu.per_nr_id=mep.per_nr_id and  mep.men_nr_id=men.men_nr_id and men.men_tx_status='A' and  men.supermenu_nr_id=0 order by men.men_nr_ordem, men_tx_nome";
            String sql = sqlEasyPortal.getSql("menu_primario_dash");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setInt(1, usu_usuarioT.getUsu_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<Men_menuT> getMenuPrimario(Usu_usuarioT usu_usuarioT, String sistema) throws Exception {
        try {
            //String sql = "select men.* from portal.pu_per_usu pu, portal.mep_men_per mep, portal.men_menu men where pu.usu_nr_id=? and pu.per_nr_id=mep.per_nr_id and  mep.men_nr_id=men.men_nr_id and men.men_tx_status='A' and  men.supermenu_nr_id=0 order by men.men_nr_ordem, men_tx_nome";
            String sql = sqlEasyPortal.getSql("menu_primario_sistema");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getAllUsuario(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            //String sql = "select distinct men.* from portal.pu_per_usu pu, portal.mep_men_per mep, portal.men_menu men where pu.usu_nr_id=? and pu.per_nr_id=mep.per_nr_id and  mep.men_nr_id=men.men_nr_id and men.men_tx_status='A' order by men.men_nr_ordem, men_tx_nome";
            String sql = sqlEasyPortal.getSql("menu_allusuario");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getAllUsuario(Usu_usuarioT usu_usuarioT, String sistema) throws Exception {
        try {
            //String sql = "select distinct men.* from portal.pu_per_usu pu, portal.mep_men_per mep, portal.men_menu men where pu.usu_nr_id=? and pu.per_nr_id=mep.per_nr_id and  mep.men_nr_id=men.men_nr_id and men.men_tx_status='A' order by men.men_nr_ordem, men_tx_nome";
            String sql = sqlEasyPortal.getSql("menu_allusuario_sistema");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, sistema);
    ...
    public List<Men_menuT> getAll() throws Exception {
        try {
            //String sql = "select * from portal.men_menu order by men_tx_nome, men_nr_id";
            String sql = sqlEasyPortal.getSql("all_menu");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<Men_menuT> getAllExceto(Men_menuT menT) throws Exception {
        try {
            //String sql = "select * from portal.men_menu  where men_nr_id <> ? order by men_tx_nome, men_nr_id";
            String sql = sqlEasyPortal.getSql("menu_allexceto");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setInt(1, menT.getMen_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<Men_menuT> getMenuPerfil(Per_perfilT perT) throws Exception {
        try {
            //String sql = "select * from portal.men_menu where men_nr_id in (select men_nr_id from portal.mep_men_per where per_nr_id=?) order by men_nr_ordem, men_tx_nome";
            String sql = sqlEasyPortal.getSql("menu_perfil");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getMenuNaoPerfil(Per_perfilT perT) throws Exception {
        try {
            //String sql = "select * from portal.men_menu where men_nr_id not in (select men_nr_id from portal.mep_men_per where per_nr_id=?) order by men_nr_ordem, men_tx_nome";
            String sql = sqlEasyPortal.getSql("menu_nao_perfil");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setInt(1, perT.getPer_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<Men_menuT> getById(Men_menuT men_menuT) throws Exception {
        try {
            ...
            String sql = sqlEasyPortal.getSql("menubyid");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, men_menuT.getMen_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<Men_menuT> getBySistema(Men_menuT men_menuT) throws Exception {
        try {
            //String sql = "select * from portal.men_menu where  sis_nr_id=?";
            String sql = sqlEasyPortal.getSql("menubysistema");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getByMen_nr_id(Men_menuT men_menuT) throws Exception {
        try {
            //String sql = "select * from portal.men_menu where  men_nr_id = ? ";
            String sql = sqlEasyPortal.getSql("menubymen_nr_id");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, men_menuT.getMen_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<Men_menuT> getBySupermenu_nr_id(Men_menuT men_menuT) throws Exception {
        try {
            //String sql = "select * from portal.men_menu where  supermenu_nr_id = ? ";
            String sql = sqlEasyPortal.getSql("menubysupermen_nr_id");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, men_menuT.getSupermenu_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<Men_menuT> getByMen_tx_status(Men_menuT men_menuT) throws Exception {
        try {
            ...
            String sql = sqlEasyPortal.getSql("menubymen_tx_status");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getByMen_tx_nome(Men_menuT men_menuT) throws Exception {
        try {
            ...
            String sql = sqlEasyPortal.getSql("menubymen_tx_nome");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getByMen_nr_ordem(Men_menuT men_menuT) throws Exception {
        try {
            //String sql = "select * from portal.men_menu where  men_nr_ordem = ? ";
            String sql = sqlEasyPortal.getSql("menubymen_nr_ordem");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getAllUsuarioDash(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            //String sql = "select distinct men.* from portal.pu_per_usu pu, portal.mep_men_per mep, portal.men_menu men where pu.usu_nr_id=? and pu.per_nr_id=mep.per_nr_id and  mep.men_nr_id=men.men_nr_id and men.men_tx_status='A' order by men.men_nr_ordem, men_tx_nome";
            String sql = sqlEasyPortal.getSql("menu_allusuario_dash");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, usu_usuarioT.getUsu_nr_id());
            rs = pStmt.executeQuery();
