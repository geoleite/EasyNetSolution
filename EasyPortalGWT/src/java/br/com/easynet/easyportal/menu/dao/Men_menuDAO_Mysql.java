...
public class Men_menuDAO_Mysql extends ObjectDAOClusterEasyPortal implements IMen_menuDAO {

    private ResultSet rs = null;
    private PreparedStatement pStmt = null;

    public Men_menuDAO_Mysql(DAOFactoryCluster dao) throws Exception {
        //setDAOFactory(dao);
        //con = dao.create();
    ...
    public void insert(Men_menuT men_menuT) throws Exception {
        try {
            String sql = "insert into men_menu  ( supermenu_nr_id, men_tx_status, men_tx_nome, men_nr_ordem, men_tx_url, sis_nr_id, men_tx_acao, men_tx_icone, men_tx_tipo) values (?, ? , ? , ? , ? , ?, ?, ?, ? )";
    ...
    public void update(Men_menuT men_menuT) throws Exception {
        try {
            String sql = "update men_menu set  supermenu_nr_id=?, men_tx_status=?, men_tx_nome=?, men_nr_ordem=?, men_tx_url=?, sis_nr_id=?, men_tx_acao=?, men_tx_icone=?, men_tx_tipo=?  where  men_nr_id=?";
            ...
            pStmt.setObject(7, men_menuT.getMen_tx_acao());
            pStmt.setObject(8, men_menuT.getMen_tx_icone());
            pStmt.setObject(9, men_menuT.getMen_tx_icone());
    ...
    public void delete(Men_menuT men_menuT) throws Exception {
        try {
            String sql = "delete from men_menu where  men_nr_id=?";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getSubMenu(Men_menuT menT) throws Exception {
        try {
            String sql = "select * from men_menu men where men.supermenu_nr_id=? order by men_nr_ordem, men_tx_nome";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getMenuPrimario(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "select men.* from pu_per_usu pu, mep_men_per mep, men_menu men where pu.usu_nr_id=? and pu.per_nr_id=mep.per_nr_id and  mep.men_nr_id=men.men_nr_id and men.men_tx_status='A' and men.men_tx_tipo='M' and  men.supermenu_nr_id=0 order by men.men_nr_ordem, men_tx_nome";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getMenuPrimarioDash(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            ...
            String sql = "select men.* from pu_per_usu pu, mep_men_per mep, men_menu men where pu.usu_nr_id=? and pu.per_nr_id=mep.per_nr_id and  mep.men_nr_id=men.men_nr_id and men.men_tx_status='A' and men.men_tx_tipo='A' and  men.supermenu_nr_id=0 order by men.men_nr_ordem, men_tx_nome";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setInt(1, usu_usuarioT.getUsu_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<Men_menuT> getAllUsuario(Usu_usuarioT usu_usuarioT) throws Exception {
        try {
            String sql = "select distinct men.* from pu_per_usu pu, mep_men_per mep, men_menu men where pu.usu_nr_id=? and pu.per_nr_id=mep.per_nr_id and  mep.men_nr_id=men.men_nr_id and men.men_tx_status='A' order by men.men_nr_ordem, men_tx_nome";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getAll() throws Exception {
        try {
            String sql = "select * from men_menu order by men_tx_nome, men_nr_id";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<Men_menuT> getAllExceto(Men_menuT menT) throws Exception {
        try {
            String sql = "select * from men_menu  where men_nr_id <> ? order by men_tx_nome, men_nr_id";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setInt(1, menT.getMen_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<Men_menuT> getMenuPerfil(Per_perfilT perT) throws Exception {
        try {
            String sql = "select * from men_menu where men_nr_id in (select men_nr_id from mep_men_per where per_nr_id=?) order by men_nr_ordem, men_tx_nome";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getMenuNaoPerfil(Per_perfilT perT) throws Exception {
        try {
            String sql = "select * from men_menu where men_nr_id not in (select men_nr_id from mep_men_per where per_nr_id=?) order by men_nr_ordem, men_tx_nome";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setInt(1, perT.getPer_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<Men_menuT> getById(Men_menuT men_menuT) throws Exception {
        try {
            String sql = "select * from men_menu where  men_nr_id=?";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, men_menuT.getMen_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<Men_menuT> getBySistema(Men_menuT men_menuT) throws Exception {
        try {
            String sql = "select * from men_menu where  sis_nr_id=?";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getBySupermenu_nr_id(Men_menuT men_menuT) throws Exception {
        try {
            String sql = "select * from men_menu where  supermenu_nr_id = ? ";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, men_menuT.getSupermenu_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<Men_menuT> getByMen_tx_status(Men_menuT men_menuT) throws Exception {
        try {
            String sql = "select * from men_menu where  Upper(men_tx_status) like Upper(?) ";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getByMen_tx_nome(Men_menuT men_menuT) throws Exception {
        try {
            String sql = "select * from men_menu where  Upper(men_tx_nome) like Upper(?) ";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getByMen_nr_ordem(Men_menuT men_menuT) throws Exception {
        try {
            String sql = "select * from men_menu where  men_nr_ordem = ? ";
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<Men_menuT> getMenuPrimario(Usu_usuarioT usu_usuarioT, String sistema) throws Exception {
        try {
            String sql = "select distinct men.* from pu_per_usu pu, mep_men_per mep, men_menu men, sis_sistema sis where sis.sis_tx_nome='?' and pu.usu_nr_id=? and pu.per_nr_id=mep.per_nr_id and  mep.men_nr_id=men.men_nr_id and men.men_tx_status='A' and  men.supermenu_nr_id=0 and men.sis_nr_id=sis.sis_nr_id order by men.men_nr_ordem, men_tx_nome";
