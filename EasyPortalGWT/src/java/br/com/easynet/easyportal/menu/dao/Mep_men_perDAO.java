...
public class Mep_men_perDAO extends ObjectDAOClusterEasyPortal implements IMep_men_perDAO {

    private ResultSet rs = null;
    private PreparedStatement pStmt = null;

    public Mep_men_perDAO(DAOFactoryCluster dao) throws Exception {
        //setDAOFactory(dao);
        //con = dao.create();
    ...
    public List<Mep_men_perT> getByPerfis(List<Per_perfilT> listPer) throws Exception  {
        try {
            ...
            perfis.append("0");
            StringBuffer sql = new StringBuffer("select * from portal.mep_men_per where per_nr_id in (");
