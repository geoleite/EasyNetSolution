...
public class LogDAO extends ObjectDAOClusterEasyPortal implements ILogDAO {

    private ResultSet rs = null;
    private PreparedStatement pStmt = null;
    private SqlEasyPortal sqlEasyPortal = new SqlEasyPortal();

    public LogDAO(DAOFactoryCluster dao) throws Exception {
        //setDAOFactory(dao);
        //con = dao.create();
    ...
    public void insert(LogT logT) throws Exception {
        try {
            //String sql = "insert into portal.log  ( log_tx_sistema, log_tx_classe, log_tx_metodo, log_dt_datahora, log_tx_usuario, log_tx_status, log_tx_ip, log_tx_parametros) values ( ? , ? , ? , ? , ? , ?, ?, ?)";
            String sql = sqlEasyPortal.getSql("insert_log");
    ...
    public void update(LogT logT) throws Exception {
        try {
            //String sql = "update portal.log set  log_tx_sistema=?, log_tx_classe=?, log_tx_metodo=?, log_dt_datahora=?, log_tx_usuario=?  where  log_nr_id=?";
            String sql = sqlEasyPortal.getSql("update_log");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, logT.getLog_tx_sistema());
            pStmt.setObject(2, logT.getLog_tx_classe());
    ...
    public void delete(LogT logT) throws Exception {
        try {
            //String sql = "delete from portal.log where  log_nr_id=?";
            String sql = sqlEasyPortal.getSql("delete_log");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<LogT> getAll() throws Exception {
        try {
            //String sql = "select * from portal.log";
            String sql = sqlEasyPortal.getSql("all_log");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<LogT> getFilterGenerico(LogT logT, String datainicial, String datafinal) throws Exception {
        try {
            ...
            StringBuffer sql = new StringBuffer("select * from portal.log where 1=1  ");
...
//          sql.append(" and log_dt_datahora between '").append(datainicial).append("' and '").append(datafinal).append("' ");
    ...
    public List<LogT> getById(LogT logT) throws Exception {
        try {
            ...
            //String sql = "select * from portal.log where  log_nr_id=?";
            String sql = sqlEasyPortal.getSql("logbyid");
    ...
    public List<LogT> getByLog_nr_id(LogT logT) throws Exception {
        try {
            //String sql = "select * from portal.log where  log_nr_id = ? ";
            String sql = sqlEasyPortal.getSql("logbylog_nr_id");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, logT.getLog_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<LogT> getByLog_tx_sistema(LogT logT) throws Exception {
        try {
            //String sql = "select * from portal.log where  Upper(log_tx_sistema) like Upper(?) ";
            String sql = sqlEasyPortal.getSql("logbylog_tx_sistema");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
            pStmt.setObject(1, '%' + logT.getLog_tx_sistema() + '%');
            rs = pStmt.executeQuery();
    ...
    public List<LogT> getByLog_tx_classe(LogT logT) throws Exception {
        try {
            //String sql = "select * from portal.log where  Upper(log_tx_classe) like Upper(?) ";
            String sql = sqlEasyPortal.getSql("logbylog_tx_classe");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<LogT> getByLog_tx_metodo(LogT logT) throws Exception {
        try {
            //String sql = "select * from portal.log where  Upper(log_tx_metodo) like Upper(?) ";
            String sql = sqlEasyPortal.getSql("logbylog_tx_metodo");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<LogT> getByLog_dt_datahora(LogT logT) throws Exception {
        try {
            //String sql = "select * from portal.log where  log_dt_datahora = ? ";
            String sql = sqlEasyPortal.getSql("logbylog_dt_datahora");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
    ...
    public List<LogT> getByLog_tx_usuario(LogT logT) throws Exception {
        try {
            //String sql = "select * from portal.log where  Upper(log_tx_usuario) like Upper(?) ";
            String sql = sqlEasyPortal.getSql("logbylog_tx_usuario");
            //pStmt = con.prepareStatement(sql);
            pStmt = createPrepareStatment(sql);
